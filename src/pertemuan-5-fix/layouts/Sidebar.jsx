        ...
        <div id="sidebar" className="flex min-h-screen w-[360px] flex-col bg-white p-10 shadow-lg">
            ...
            <div id="sidebar-menu" className="mt-10">
                <ul id="menu-list" className="space-y-3">
                    ...
                    <li>
                        <div id="menu-1" className="flex items-center cursor-pointer rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:text-hijau hover:font-extrabold">
                    ...
                    <li>
                        <div id="menu-2" className="flex items-center cursor-pointer rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:text-hijau hover:font-extrabold">
                    ...
                    <li>
                        <div id="menu-3" className="flex items-center cursor-pointer rounded-xl p-4 font-medium text-gray-600 hover:bg-green-200 hover:text-hijau hover:font-extrabold">
